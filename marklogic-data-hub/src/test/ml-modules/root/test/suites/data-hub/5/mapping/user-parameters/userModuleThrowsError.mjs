...
try {
  ...
  assertions.push(
    test.assertEqual("Unable to apply mapping parameters module at path '/test/suites/data-hub/5/mapping/user-parameters/test-data/bad-get-parameter-values.mjs'; " +
