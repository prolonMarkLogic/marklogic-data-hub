...
const doc = fn.head(xdmp.unquote(`<es:envelope xmlns:es='http://marklogic.com/entity-services'>
    <es:instance>
      <es:info><es:title>MyEntity</es:title></es:info>
      <MyEntity xmlns='org:example'><myProperty>myValue</myProperty></MyEntity>
    </es:instance>
  </es:envelope>`));
