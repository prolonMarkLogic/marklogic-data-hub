...
assertions.concat([
  ...
  test.assertEqual(8, resultsTest2.edges.length, `4 edges for new nodes + 4 edges from the new nodes so they'll connect if already on the graph. Output: ${xdmp.toJsonString(resultsTest2)}`)
]);
