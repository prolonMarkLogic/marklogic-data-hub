...
xdmp.invokeFunction(() => {
  let provDocument;
  let stepExecutionContext = new StepExecutionContext(fakeFlow, "1", {
    name: "myCustomStep",
    type: "custom"
  }, "my-job-id", {latestProvenance: true, targetDatabase: stagingDB});
  ...
  flowProvenance.writeProvenanceData(stepExecutionContext, [
    {
      uri: "testJSONNodeInstance.json",
      value: xdmp.toJSON({envelope: {instance: {info: {title: "Customer", version: "0.0.1"}}}})
    }
  ]);
  provenanceWriteQueue.persist(stagingDB);
